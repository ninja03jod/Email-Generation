...
#  │  HOW TO USE                                                             │
#  │  ─────────                                                              │
#  │  1. Set GROQ_API_KEY at the top of this file (line ~28)                 │
#  │  2. Scroll down to main() below                                         │
#  │  3. Fill in your 5 inputs inside the YOUR INPUTS block                  │
#  │  4. Run:  python email_generator.py                                     │
#  │                                                                         │
#  │  TONE OPTIONS (pick exactly one):                                       │
#  │    "formal"      → Professional, structured, executive-level            │
#  │    "casual"      → Friendly, relaxed, conversational                    │
#  │    "urgent"      → Action-required, no fluff, direct                    │
#  │    "empathetic"  → Warm, understanding, apologetic                      │
#  │    "persuasive"  → Compelling, benefit-led, call-to-action              │
#  │                                                                         │
#  │  KEY FACTS TIPS:                                                        │
#  │    • Add 2–6 bullet facts — ALL will be woven into the email            │
#  │    • Be specific: dates, numbers, names, deadlines                      │
#  │    • Each fact = one string in the list                                 │
#  └─────────────────────────────────────────────────────────────────────────┘
#
# =============================================================================
...
# =============================================================================
#  INPUT EXAMPLES — Copy any block below into main() to try different emails
# =============================================================================

# ── EXAMPLE A: Sales Follow-Up (formal) ──────────────────────────────────────
...
# ── EXAMPLE B: Apology / Missed Deadline (empathetic) ────────────────────────
...
# ── EXAMPLE C: Production Outage Alert (urgent) ───────────────────────────────
...
# ── EXAMPLE D: Product Pitch (persuasive) ────────────────────────────────────
...
# ── EXAMPLE E: Team Event Invite (casual) ─────────────────────────────────────
...
# ── EXAMPLE F: Request Meeting with Manager (formal) ─────────────────────────
...
# ── EXAMPLE G: Client Onboarding Welcome (casual) ─────────────────────────────
# intent         = "Send a warm welcome email to a new client who just signed up"
# key_facts      = [
...
# ── EXAMPLE H: Investor Update (formal) ───────────────────────────────────────
